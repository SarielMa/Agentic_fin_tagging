...
SRC="${REPO_ROOT}/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_frozen_ags"
VERDICTS_DIR="${REPO_ROOT}/runs_ags_verifier_ablation/qwen3_32b/verdicts_fulltagging"
OUT="${REPO_ROOT}/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_llmonly_verification"
...
sbatch "${REPO_ROOT}/apply_server_fulltagging_llmonly_rerank.sh"
