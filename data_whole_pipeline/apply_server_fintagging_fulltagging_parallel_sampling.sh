#!/bin/bash
#SBATCH --job-name=fintag_full_parallel
...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_fintag_fulltagging_parallel_sampling_qwen3_b200.txt
#SBATCH --mail-user=linhai.ma@yale.edu

set -euo pipefail

# FullTagging parallel sampling:
#   extractor predictions first, then B independent grounding hypotheses fused by RRF.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${RUNS_ROOT}/${EXTRACTOR_TAG}/qwen3_32b_parallel_sampling}"
