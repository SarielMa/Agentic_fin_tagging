...
See ags_t7_t28/efficiency.py's module docstring for the four logging complications this has to
...
retry, and the shared listwise-rerank call that lives outside every method's counter).
    ...
    python ags_t7_t28/run_t7_efficiency.py                    # full table
    python ags_t7_t28/run_t7_efficiency.py --limit 50         # smoke test
    python ags_t7_t28/run_t7_efficiency.py --report-wallclock # opt in to the column
"""
...
from ags_t7_t28.efficiency import (  # noqa: E402
    DEFAULT_RUNS_DIR,
