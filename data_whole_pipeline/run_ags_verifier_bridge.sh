...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs_ags_verifier_bridge/qwen3_32b}"
...
LLM_SUMMARY="${LLM_SUMMARY:-${REPO_ROOT}/runs_ags_table5_ablation/qwen3_32b/llm_verifier_summary.json}"
ABLATION_CSV="${ABLATION_CSV:-${REPO_ROOT}/runs_ags_table5_ablation/qwen3_32b/ablation.csv}"
RERANKER_ROW_CSV="${RERANKER_ROW_CSV:-${REPO_ROOT}/runs_ags_table5_ablation/qwen3_32b/llm_verifier_row.csv}"
TOP20_OVERLAP="${TOP20_OVERLAP:-${REPO_ROOT}/runs_ags_table5_ablation/qwen3_32b/verifier_top20_overlap.json}"
DEPLOYED_METRICS="${DEPLOYED_METRICS:-${REPO_ROOT}/runs_fintagging_grounding_baseline/qwen3_32b_frozen_ags/metrics.json}"
TOP_M="${TOP_M:-10}"
