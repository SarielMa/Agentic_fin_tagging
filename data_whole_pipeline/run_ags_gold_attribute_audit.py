...
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "runs_ags_gold_attribute_audit" / "qwen3_32b"
DEFAULT_EVENTS_PATH = SCRIPT_DIR / "runs_ags_revision_effectiveness" / "qwen3_32b" / "per_event.jsonl"
