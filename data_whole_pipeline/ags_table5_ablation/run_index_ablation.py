...
AGS's own ranking is rebuilt through ags_table5_ablation.core.evaluate at the frozen
...
from ags_table5_ablation.core import AblationConfig, FactRecord, aggregate, evaluate  # noqa: E402
