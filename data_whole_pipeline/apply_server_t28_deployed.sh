...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_t28_deployed_%x.txt
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs_ags_t28_deployed/${RETRIEVER}_${METHOD}}"
EMBED_CACHE="${EMBED_CACHE:-${REPO_ROOT}/runs_ags_t7_t28/qwen3_32b/dense_embeddings.pt}"
...
python run_fintagging_grounding_baseline.py \
  --test-jsonl "${REPO_ROOT}/FinTagging_800_200_grounding_test_JSON/data/test.jsonl" \
