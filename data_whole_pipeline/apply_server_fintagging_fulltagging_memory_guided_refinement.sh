#!/bin/bash
#SBATCH --job-name=fintag_full_memory
...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_fintag_fulltagging_memory_guided_refinement_qwen3_b200.txt
#SBATCH --mail-user=linhai.ma@yale.edu

set -euo pipefail

# FullTagging memory-guided refinement:
#   extractor predictions first, then online memory-guided operator refinement.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${RUNS_ROOT}/${EXTRACTOR_TAG}/qwen3_32b_memory_guided_refinement}"
