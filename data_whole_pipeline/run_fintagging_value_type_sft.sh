...
PIPELINE_ROOT="${PIPELINE_ROOT:-${REPO_ROOT}/runs_fintagging_value_type}"
...
require_path "${REPO_ROOT}/evaluate_fintagging_value_type.py" "evaluation script"
...
if [[ "${EVAL}" == "1" ]]; then
  ...
  python "${REPO_ROOT}/evaluate_fintagging_value_type.py" \
