...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_ags_coverage_pilot_qwen3_b200.txt
...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs_ags_coverage_pilot/qwen3_32b}"
...
python -m py_compile "${REPO_ROOT}/run_ags_coverage_pilot.py"
python "${REPO_ROOT}/run_ags_coverage_pilot.py" "${ARGS[@]}"
