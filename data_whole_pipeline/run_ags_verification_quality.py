...
from ags_table5_ablation.core import LLM_VERIFIER_DIMENSIONS_DEFAULT


DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "runs_ags_verification_quality" / "qwen3_32b"
DEFAULT_TEST_TRACE = (
...
DEFAULT_SEQ_TRACES = {
    "learned": SCRIPT_DIR / "runs_fintagging_grounding_baseline" / "qwen3_32b_ags_seq" / "grounding_traces.jsonl",
    "random": SCRIPT_DIR
