...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_ags_component_validation_qwen3_b200.txt
...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs_ags_component_validation/qwen3_32b}"
