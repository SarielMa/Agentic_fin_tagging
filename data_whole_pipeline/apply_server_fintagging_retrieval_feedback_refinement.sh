#!/bin/bash
#SBATCH --job-name=fintag_feedback
...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/data_whole_pipeline/%j_fintag_retrieval_feedback_refinement_qwen3_b200.txt
#SBATCH --mail-user=linhai.ma@yale.edu

set -euo pipefail

# Retrieval-feedback refinement:
#   Qwen revises the retrieval query for B rounds after seeing top retrieved candidates.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${RUNS_ROOT}/qwen3_32b_retrieval_feedback_refinement}"
