...
DEFAULT_OUTPUT_DIR = FHS_ROOT / "runs" / "runs_ags_stage_decomposition" / "qwen3_32b"
...
DEFAULT_ABLATION_DIR = FHS_ROOT / "runs" / "runs_ags_config_ablation" / "qwen3_32b"
...
def main() -> None:
    ...
    metrics = {
        ...
        "supersedes": str(FHS_ROOT / "runs" / "runs_ags_pipeline_vs_direct" / "qwen3_32b" / "stage_decomposition.csv"),
