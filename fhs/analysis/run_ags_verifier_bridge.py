...
DEFAULT_LLM_SUMMARY = FHS_ROOT / "runs" / "runs_ags_table5_ablation" / "qwen3_32b" / "llm_verifier_summary.json"
DEFAULT_ABLATION_CSV = FHS_ROOT / "runs" / "runs_ags_table5_ablation" / "qwen3_32b" / "ablation.csv"
DEFAULT_RERANKER_ROW_CSV = FHS_ROOT / "runs" / "runs_ags_table5_ablation" / "qwen3_32b" / "llm_verifier_row.csv"
DEFAULT_TOP20_OVERLAP = FHS_ROOT / "runs" / "runs_ags_table5_ablation" / "qwen3_32b" / "verifier_top20_overlap.json"
DEFAULT_DEPLOYED_METRICS = (
    FHS_ROOT / "runs" / "runs_fintagging_grounding_baseline" / "qwen3_32b_frozen_ags" / "metrics.json"
)
