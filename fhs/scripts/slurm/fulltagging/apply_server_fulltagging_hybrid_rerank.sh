...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/fhs%j_full_hybrid_rerank.txt
...
OUT="${OUT:-${REPO_ROOT}/runs/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_hybrid_verification}"
