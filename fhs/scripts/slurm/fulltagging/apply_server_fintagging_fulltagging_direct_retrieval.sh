...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/fhs%j_fintag_fulltagging_direct_retrieval_qwen3_b200.txt
...
REPO_ROOT="${FHS_ROOT}"
PIPELINE_SH="${REPO_ROOT}/attic/run_fintagging_fulltagging.sh"
...
mkdir -p "${HF_HOME}" "${HF_DATASETS_CACHE}" "${TRANSFORMERS_CACHE}" "${HF_HUB_CACHE}" "${VLLM_CACHE_ROOT}" "${TORCH_HOME}"
...
export TEXT_EXTRACTOR_MODEL="${TEXT_EXTRACTOR_MODEL:-${REPO_ROOT}/runs/runs_fintagging_text_context/qwen2.5_14b_instruct/sft_3ep/merged}"
export TABLE_EXTRACTOR_MODEL="${TABLE_EXTRACTOR_MODEL:-${REPO_ROOT}/runs/runs_fintagging_table_context/qwen2.5_14b_instruct/sft_3ep/merged}"
export TEXT_EXTRACTION_PREDICTIONS="${TEXT_EXTRACTION_PREDICTIONS:-${REPO_ROOT}/runs/runs_fintagging_text_context/qwen2.5_14b_instruct/sft_3ep/predictions/test_predictions.jsonl}"
export TABLE_EXTRACTION_PREDICTIONS="${TABLE_EXTRACTION_PREDICTIONS:-${REPO_ROOT}/runs/runs_fintagging_table_context/qwen2.5_14b_instruct/sft_3ep/predictions/test_predictions.jsonl}"
