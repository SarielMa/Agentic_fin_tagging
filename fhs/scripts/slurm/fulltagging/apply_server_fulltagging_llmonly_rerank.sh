...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/fhs%j_full_llmonly_rerank.txt
...
SRC="${SRC:-${REPO_ROOT}/runs/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_frozen_ags}"
VERDICTS_DIR="${VERDICTS_DIR:-${REPO_ROOT}/runs/runs_ags_verifier_ablation/qwen3_32b/verdicts_fulltagging}"
OUT="${OUT:-${REPO_ROOT}/runs/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_llmonly_verification}"
...
export RUNS_ROOT="${REPO_ROOT}/runs/runs_fintagging_fulltagging"
