...
#SBATCH --output=/nfs/roberts/project/pi_sjf37/lm2445/FinAI_tagging_agentic/fhs%j_ags_reward_diagnostic_qwen3_b200.txt
...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs/runs_ags_reward_diagnostic/qwen3_32b}"
export COMPONENT_OUTPUT_DIR="${COMPONENT_OUTPUT_DIR:-${REPO_ROOT}/runs/runs_ags_component_validation/qwen3_32b}"
...
python -m py_compile \
  ...
  "${REPO_ROOT}/analysis/run_ags_reward_diagnostic.py"
python -m unittest \
  "${REPO_ROOT}/tests/test_ags_symbolic_agreement.py" \
  "${REPO_ROOT}/tests/test_label_coverage_retriever.py"
python "${REPO_ROOT}/analysis/run_ags_reward_diagnostic.py" "${ARGS[@]}"
