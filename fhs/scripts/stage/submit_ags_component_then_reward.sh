...
COMPONENT_SCRIPT="${COMPONENT_SCRIPT:-${REPO_ROOT}/scripts/slurm/apply_server_ags_component_validation.sh}"
REWARD_SCRIPT="${REWARD_SCRIPT:-${REPO_ROOT}/scripts/slurm/apply_server_ags_reward_diagnostic.sh}"

COMPONENT_OUTPUT_DIR="${COMPONENT_OUTPUT_DIR:-${REPO_ROOT}/runs/runs_ags_component_validation/qwen3_32b}"
REWARD_OUTPUT_DIR="${REWARD_OUTPUT_DIR:-${REPO_ROOT}/runs/runs_ags_reward_diagnostic/qwen3_32b}"
