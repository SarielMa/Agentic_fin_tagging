...
while true; do
  ...
  FT="${REPO}/runs/runs_fintagging_fulltagging/qwen2.5_14b_extractors/qwen3_32b_llmonly_verification"
  ...
  REMAINING=$(python "${REPO}/tools/count_placeholders.py" "${PAPER}" 2>/dev/null || echo "?")
