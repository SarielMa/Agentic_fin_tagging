...
DEFAULT_TAXONOMY_JSONL = (
    FHS_ROOT / "data" / "taxonomy" / "us_gaap_2024_enriched_retrieval.jsonl"
)
DEFAULT_OUTPUT_DIR = FHS_ROOT / "runs" / "runs_fintagging_grounding_baseline" / "qwen3_32b_direct_retrieval"
