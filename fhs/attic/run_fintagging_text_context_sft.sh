...
PIPELINE_ROOT="${PIPELINE_ROOT:-${REPO_ROOT}/runs/runs_fintagging_text_context}"
...
require_path "${REPO_ROOT}/attic/evaluate_fintagging_context_extraction.py" "context extraction evaluator"
...
if [[ "${EVAL}" == "1" ]]; then
  ...
  python "${REPO_ROOT}/attic/evaluate_fintagging_context_extraction.py" \
